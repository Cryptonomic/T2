...
function ActionPanel() {
    ...
    const { balance, activeTab, storeType, status, script, delegate_value, regularAddresses, transactions, storage } = selectedAccount;
    ...
    function renderSection() {
        ...
        switch (activeTab) {
            ...
            case INVOKE:
                return <Invoke isReady={ready} addresses={regularAddresses} onSuccess={() => onChangeTab(TRANSACTIONS)} />;
            case TRANSACTIONS:
            default: {
                if (!ready) {
