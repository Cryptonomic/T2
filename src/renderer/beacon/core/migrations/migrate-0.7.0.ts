import { PermissionScope, AccountIdentifier, Origin, Network, P2PPairingRequest, StorageKey, AccountInfo } from '@airgap/beacon-types';
...
export const migrate_0_7_0 = async (storage: Storage): Promise<void> => {
    ...
    // Migrate P2PPeers
    const P2PPairingRequests: P2PPairingRequest[] = await storage.get(StorageKey.TRANSPORT_P2P_PEERS_DAPP);
