...
export abstract class Client extends BeaconClient {
    ...
    constructor(config: ClientOptions) {
        ...
        this.handleResponse = (message: BeaconBaseMessage | BeaconMessageWrapper<BeaconBaseMessage>, connectionInfo: ConnectionContext): void => {
    ...
    protected async sendDisconnectToPeer(peer: PeerInfo, transport?: Transport<any>): Promise<void> {
        const request: DisconnectMessage = {
            id: await window.electron.beacon.utils.generateGUID(),
