import { BeaconMessage, BeaconMessageType, PermissionScope, PermissionEntity } from '@airgap/beacon-types';
    ...
    public static async hasPermission(
        ...
        switch (message.type) {
            ...
            case BeaconMessageType.SignPayloadRequest: {
                ...
                return filteredPermissions.some((permission: PermissionEntity) => permission.scopes.includes(PermissionScope.SIGN));
            }
            default:
