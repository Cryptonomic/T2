import { TransportType, TransportStatus, PeerInfo, StorageKey, StorageKeyReturnType, ConnectionContext } from '@airgap/beacon-types';
...
> {
     ...
     */
    public async addListener(listener: (message: unknown, connectionInfo: ConnectionContext) => void): Promise<void> {
     ...
     * @param listener
     */
    public async removeListener(listener: (message: string, connectionInfo: ConnectionContext) => void): Promise<void> {
    ...
    public async addPeer(newPeer: T, _sendPairingResponse = true): Promise<void> {
     ...
     */
    protected async notifyListeners(message: unknown, connectionInfo: ConnectionContext): Promise<void> {
