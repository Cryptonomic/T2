    ...
    return (
        <CreateContainer onKeyDown={(event) => onEnterPress(event.key, isDisabled)}>
            <WalletContainers>
                ...
                <WalletTitle>{t('containers.loginCreate.create_wallet_title') as string}</WalletTitle>
                <WalletDescription>{t('containers.loginCreate.create_wallet_description') as string}</WalletDescription>
                <FormContainer>
                    {/* <CreateFileSelector>
                ...
                <ActionButton onClick={() => onLogin(CREATE)} color="secondary" variant="extended" disabled={isDisabled}>
                    {t('general.verbs.continue') as string}
                </ActionButton>
            </WalletContainers>
        </CreateContainer>
    );
