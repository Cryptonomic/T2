...
import { CHANGE_LOCALE, CHANGE_NODE, ADD_NODE, REMOVE_NODE, CHANGE_PATH, ADD_PATH, REMOVE_PATH, INIT_SETTINGS, SettingsActionTypes } from './types';

import { SettingsState } from '../../../types/store';

export function settingsReducer(state = defaultSettings, action: SettingsActionTypes): SettingsState {
    switch (action.type) {
        case CHANGE_LOCALE: {
