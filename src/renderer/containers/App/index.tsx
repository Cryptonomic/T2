        ...
        window.electron.ipcRenderer.on('wallet', async (url) => {
            ...
            try {
                if (searchParams.has('type') && searchParams.get('type') === 'tzip10') {
                    ...
                    dispatch(setModalValue(JSON.parse(window.electron.buffer.fromString(req, 'base64', 'utf8')), pathname));
                    ...
                    if (pathname === 'sign') {
                        ...
                        dispatch(setModalValue(JSON.parse(window.electron.buffer.fromString(req, 'base64', 'utf8')), 'beaconDisable'));
                        dispatch(setModalOpen(true, 'beaconDisable'));
                    }
