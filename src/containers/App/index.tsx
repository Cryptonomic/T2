...
import { getNewVersionThunk, setCustomProtocolThunk } from '../../reduxContent/app/thunks';
...
function App() {
    ...
    const { newVersion, isLedger, isLoading, customProtocol } = useSelector<RootState, AppState>(state => state.app, shallowEqual);
    ...
    useEffect(() => {
        ...
        dispatch(setCustomProtocolThunk(customProtocol, true));
