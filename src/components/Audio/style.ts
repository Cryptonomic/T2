...
/**
 * Style of the container wrapping the audio, loader and error box.
 */
 ...
 * The loader.
 */
export const AudioLoader = styled.div<{ visible: boolean }>`
    width: 100%;
    min-height: 200px;
    height: 100%;
...
export const DefaultAudioIcon = styled(SpeakerIcon)`
    color: ${({ theme: { colors } }) => colors.gray18};
    font-size: 43px !important;
`;
