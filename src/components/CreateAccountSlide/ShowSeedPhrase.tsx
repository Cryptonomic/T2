...
function ShowSeedPhrase(props: Props) {
    ...
    return (
        <Fragment>
            ...
            <IconContainer>
                <div>
                    <CopyButton title={t('components.createAccountSlide.copy_seed')} text={processedSeed} color="#2c7df7" />
                </div>
                <div>
                    <RefreshButton color="secondary" disableRipple={true} onClick={() => onUpdate()} startIcon={<RefreshIconWrapper />}>
